    ...
    return (
        <div className="min-h-screen bg-zinc-800 text-white px-6 py-16 md:px-24">
            <div className="max-w-6xl mx-auto">
                ...
                <p className="text-center text-gray-300 text-[16px] mb-12 animate-slide-up">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center animate-fade-in delay-300">
                    <div className="bg-zinc-700 rounded-lg p-6 shadow-md hover:shadow-xl transition hover:scale-105">
                        ...
                        <p className="text-gray-400 text-[16px]">Memorize concepts faster with interactive and spaced-repetition flashcards.</p>
                    </div>
                    <div className="bg-zinc-700 rounded-lg p-6 shadow-md hover:shadow-xl transition hover:scale-105">
                        <FaClock className="text-4xl mx-auto mb-3 text-[#f23064]" />
                        <h3 className="text-xl font-semibold mb-2">Pomodoro Sessions</h3>
                        <p className="text-gray-400 text-[16px]">Stay focused with custom task timers, breaks, and productivity tracking.</p>
                    </div>
                    <div className="bg-zinc-700 rounded-lg p-6 shadow-md hover:shadow-xl transition hover:scale-105">
                        <FaClipboardList className="text-4xl mx-auto mb-3 text-[#f23064]" />
                        <h3 className="text-xl font-semibold mb-2">Habit Tracker</h3>
                        <p className="text-gray-400 text-[16px]">Build daily routines and track habits that lead to success, day by day.</p>
                    </div>
                    <div className="bg-zinc-700 rounded-lg p-6 shadow-md hover:shadow-xl transition hover:scale-105">
                        <FaBookOpen className="text-4xl mx-auto mb-3 text-[#f23064]" />
                        <h3 className="text-xl font-semibold mb-2">Organized Notes</h3>
                        <p className="text-gray-400 text-[16px]">Keep all your key points and study material in one place — clean and searchable.</p>
                    </div>
                    <div className="bg-zinc-700 rounded-lg p-6 shadow-md hover:shadow-xl transition hover:scale-105">
                        <FaBolt className="text-4xl mx-auto mb-3 text-[#f23064]" />
                        <h3 className="text-xl font-semibold mb-2">Text Summarizer</h3>
                        <p className="text-gray-400 text-[16px]">Get the gist of long articles instantly using our built-in AI summarization tool.</p>
                    </div>
                    <div className="bg-zinc-700 rounded-lg p-6 shadow-md hover:shadow-xl transition hover:scale-105">
                        <FaLayerGroup className="text-4xl mx-auto mb-3 text-[#f23064]" />
                        <h3 className="text-xl font-semibold mb-2">All-in-One</h3>
                        <p className="text-gray-400 text-[16px]">No need for 5 different apps. FocusFlow brings everything into one seamless dashboard.</p>
                    </div>
                </div>
                ...
                <div className="text-center mt-20 animate-slide-up delay-500">
                    ...
                    <p className="text-gray-400 mb-6 text-xl">Join thousands of learners using FocusFlow to achieve academic excellence.</p>
                    <a
                        href="/signup"
